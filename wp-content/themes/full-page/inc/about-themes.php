...
<div class="wrapper-info">
	<div class="col-left">
          ...
          <p><?php esc_attr_e('SKT Full Page is full wide page slider which is simple, flexible, easy to use, WooCommerce friendly. Industries like food, recipe, chef, restaurant, bistro, cafe, model, portfolio, resume, IT software computers, maintenance, events, concerts, hotel, resort, motel, health, fitness, yoga and gym. WordPress 5.0 gutenberg editor friendly.','full-page'); ?></p>
	...
	<div class="col-right">			
			<div class="centerbold">
				<hr />
				<a href="<?php echo esc_url(FULL_PAGE_SKTTHEMES_LIVE_DEMO); ?>" target="_blank"><?php esc_attr_e('Live Demo', 'full-page'); ?></a> | 
				<a href="<?php echo esc_url(FULL_PAGE_SKTTHEMES_PRO_THEME_URL); ?>"><?php esc_attr_e('Buy Pro', 'full-page'); ?></a> | 
				<a href="<?php echo esc_url(FULL_PAGE_SKTTHEMES_THEME_DOC); ?>" target="_blank"><?php esc_attr_e('Documentation', 'full-page'); ?></a>

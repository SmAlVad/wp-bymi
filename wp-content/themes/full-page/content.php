...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <header class="entry-header">           
        ...
        <?php if ( 'post' == get_post_type() ) : ?>
            <div class="postmeta">
                ...
                <div class="post-categories"> &nbsp;|&nbsp; <?php the_category( esc_attr__( ', ', 'full-page' )); ?></div>                  
            </div><!-- postmeta -->
        <?php endif; ?>
    </header><!-- .entry-header -->
    ...
    <div class="entry-content">
        <?php the_content( esc_html__( 'Continue reading <span class="meta-nav">&rarr;</span>', 'full-page' ) ); ?>          
    </div><!-- .entry-content -->
    <?php endif; ?>
    <div class="clear"></div>
</article><!-- #post-## -->

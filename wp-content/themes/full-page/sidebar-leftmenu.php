...
<div id="fullpage-sidebar">
      ...
      <div class="mobmenu">	
        <a href="<?php echo esc_url('#');?>" class="show_hide togmenu"><?php esc_attr_e('Menu', 'full-page');?></a>	
        <a href="<?php echo esc_url('#');?>" class="show_hide1 togmenu"><?php esc_attr_e('Menu', 'full-page');?></a>
      </div>
      	<?php
